...
control 'cis-dil-benchmark-4.1.3' do
  ...
  describe.one do
    %w(/boot/grub/grub.conf /boot/grub/grub.cfg /boot/grub/menu.lst /boot/boot/grub/grub.conf /boot/boot/grub/grub.cfg /boot/boot/grub/menu.lst /boot/grub2/grub.cfg /etc/default/grub).each do |f|
      describe file(f) do
